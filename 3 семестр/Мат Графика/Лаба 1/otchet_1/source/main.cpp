...
int main()
{
   ...
   while (true)
   {
      ...
      {
         case NONE: break;
         case FILL_1: fill_1(left, top, width, height, 2); break;
         case FILL_2: fill_2(left, top, width, height, 2); break;
         case FILL_3: fill_3(left, top, width, height, 2); break;
         case FILL_4: fill_4(left, top, width, height, 2); break;
         case FILL_5: fill_5(left, top, width, height, 2); break;
         case FILL_6: fill_6(left, top, width, height, 2); break;
         case FILL_7: fill_7(left, top, width, height, 2); break;
         case FILL_8: fill_8(left, top, width, height, 2); break;
