...
void zuballC(double zu_ball[5]) //шар в лягушке
{
   zu_ball[0] = width/2;
   zu_ball[1] = height/2;
...
void newgame(double zu_ball[5]) // задание переменных для новой игры
{
   n = 1;
   score = 0;
   createBall(0);
...
void flyBall(double zu_ball[5]) // полёт шара после выстрела
{
